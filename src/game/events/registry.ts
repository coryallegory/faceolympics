...
export const eventFactories:Record<string,()=>FaceOlympicsEvent>={'blink-off':()=>new BlinkOffEvent(),'face-weightlifting':()=>new FaceWeightliftingEvent(),'dragon-blast':()=>new DragonBlastEvent()};
