...
export const overlayPaths: readonly OverlayPath[] = [
  ...
  { name: 'Left pupil / iris', color: '#facc15', points: [468, 469], renderAs: 'circle', hideWhen: { blendshape: 'eyeBlinkRight', above: 0.4 } },
  { name: 'Right pupil / iris',color: '#fde047', points: [473, 474], renderAs: 'circle', hideWhen: { blendshape: 'eyeBlinkLeft',  above: 0.4 } },
