...
- Include the PR preview URL, `https://coryallegory.github.io/faceolympics/pr/`, in each completed task response when a PR is created.
...
- The Pages workflow publishes each PR to the shared preview URL: `https://coryallegory.github.io/faceolympics/pr/`.
- CI validates the PR.
