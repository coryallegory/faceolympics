...
PR preview URL: <https://coryallegory.github.io/faceolympics/pr/?v=CAL-COPY-09>
...
Codex tasks that create a PR should finish with a cache-busted PR preview URL using the current visible calibration build code, for example `https://coryallegory.github.io/faceolympics/pr/?v=CAL-COPY-09`, so reviewers can test the branch before merge without reusing a stale browser cache.
